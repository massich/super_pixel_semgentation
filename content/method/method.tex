...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.34\textwidth}
        \centering
        \begin{tikzpicture}
          \node[inner sep=0, draw] (breast) {\includegraphics[width=0.5\textwidth]{breast}};
          \node[inner sep=0, draw, below= of breast] (slice) {\includegraphics[width=0.5\textwidth]{slice}};
        \end{tikzpicture}
