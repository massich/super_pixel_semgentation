...
\Cref{fig:methodTerms:problem} illustrates the super-pixels idea showing a \ac{bus} image example and a its associated super-pixels representation $\mathcal{S}$ coloured according to the image's \ac{gt}.
