...
\Cref{fig:results:perfect} shows how the delineation resulting from a proper labeling of the super-pixels differs from the \ac{gt}.
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
      {\footnotesize \input{content/results/figures/method_resume.tex}}
