...
\definecolor{autoGuided}{rgb}{0 0 0}
  \newcommand{\autoGuidedColor}{(light-Blue)}
  \definecolor{fullyAuto}{rgb}{ 0 0 0 }
  \newcommand{\fullyAutoColor}{(dark-blue)}
  \definecolor{semiAuto}{rgb}{0 0 0}
  \newcommand{\semiAutoColor}{(light-green)}
  \definecolor{fullyGuided}{rgb}{0 0 0}
  \newcommand{\fullyGuidedColor}{(dark-green)}
  \definecolor{colorTheme}{RGB}{0 0 0 }

  \def\labels{	
    {\color{semiAuto}   c\cite{AlemanFlores:2007p14310}},
    {\color{semiAuto}   b\cite{Gao:2012p14336}},
    {\color{fullyAuto}  a\cite{Liu:2010p14328}},
    {\color{semiAuto}   p\cite{Cui:2009p14325}},					
    {\color{autoGuided} o\cite{Huang:2007p6100}},
    {\color{fullyAuto}  n\cite{Huang:2005p11636}},
    {\color{semiAuto}   m\cite{Gomez:2010p14339}},
    {\color{semiAuto}   l\cite{Horsch:2001p6028}},
    {\color{fullyAuto}  k\cite{Yeh:2009p11985}},
    {\color{autoGuided} j\cite{Shan:2012p14347}},
    {\color{autoGuided} i\cite{massich2010lesion}},
    {\color{semiAuto}   h\cite{Xiao:2002p5639,gerard2013}},
    {\color{autoGuided} g\cite{Zhang:2010p14317}},
    {\color{fullyAuto}  f\cite{hao2012combining}},
    {\color{autoGuided} e\cite{Madabhushi:2003p6036}},
    {\color{fullyAuto}  d\cite{Huang:2012p14313}}}
