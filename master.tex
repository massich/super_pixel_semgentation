...
\begin{abstract}
  ...
  The main reason for using \ac*{us} imaging is its capability for differencing between benign and malignant masses, when compared to other imaging techniques.
  ...
  The proposal takes advantage of optimization strategy using super-pixels and high-level descriptors, which are analogous to the visual cues used by radiologists for diagnosis.
