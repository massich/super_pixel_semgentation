...
This lead to new developments in \ac*{cad} systems applied to breast cancer and \acs*{us} images.
...
This article proposes a highly modular and flexible framework for segmenting lesions and tissues present in \ac*{bus} images, which takes advantage of optimization strategy using super-pixels and high-level descriptors similar to the visual cues used by radiologists for diagnosis.
